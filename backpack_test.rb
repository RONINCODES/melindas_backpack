...
class BackpackTest < MiniTest::Test
  ...
  def test_that_packs_gym_shoes_on_tuesdays_and_thursdays
  ...
  def test_that_doesnt_pack_gym_shoes_on_non_gym_days
    ['monday', 'wednesday', 'friday', 'saturday', 'sunday'].each do |day|
      backpack = build(:backpack, day_of_week: day)
